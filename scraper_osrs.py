...
class OSRSGrandExchangeApp(App):
    ...
    def build(self):
        ...
        header = Label(
            text="OSRS Grand Exchange Helper",
            size_hint=(1, None),
            height=50,
            font_size=24,
            bold=True,
        ...
        self.starting_gold_input = TextInput(
            text="10000",
            multiline=False,
            size_hint=(0.7, None),
            height=40,
        ...
        self.fetch_button = Button(
            text="Fetch Prices and Generate Suggestions",
            size_hint=(1, None),
            height=50,
